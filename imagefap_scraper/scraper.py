...
def scrape_picture(picture_url, save_location, ids, verbose, gallery_name):
    ...
    username, gallery_id, picture_id, picture_name_full, filetype = information_from_picture_dl_url(
        picture_dl_url
    )
...
def scrape_gallery(
    gallery_url, save_location="downloads", ids=False, verbose=False, parallel=False
):
    """
    ...
    if not parallel:
        ...
        for picture_url in picture_urls_from_gallery_url(gallery_url):
            scrape_picture(picture_url, save_location, ids, verbose, gallery_name)
